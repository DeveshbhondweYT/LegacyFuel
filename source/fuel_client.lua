					...
					if not DoesEntityExist(GetPedInVehicleSeat(vehicle, -1)) then
						...
						if GetVehicleFuelLevel(vehicle) < 95 and canFuel then
							if currentCash > 0 then
								DrawText3Ds(stringCoords.x, stringCoords.y, stringCoords.z + 1.6, "Press ~r~E~w~ to open the tank menu.")
								...
								DrawText3Ds(stringCoords.x, stringCoords.y, stringCoords.z + 1.2, "~r~You Don't have money, do you want to steal from me?")
							end
						elseif not canFuel then
						else
							DrawText3Ds(stringCoords.x, stringCoords.y, stringCoords.z + 1.6, "You can no longer fill up with ~r~fuel~w~")
						end
					end
